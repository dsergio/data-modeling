...
plt.scatter(query_result['Spd'], query_result['Dir'], c= kmeans.labels_.astype(float), s=50, alpha=0.5)
plt.scatter(centroids[:, 0], centroids[:, 1], c='red', s=50)
plt.xlabel("Windspeed")
plt.ylabel("Direction")
plt.title("KMeans Windspeed / Direction")
plt.savefig(".\\plots\\kmeansWindspeedDir.png")