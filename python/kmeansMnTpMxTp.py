...
plt.scatter(query_result['MnTp'], query_result['MxTp'], c= kmeans.labels_.astype(float), s=50, alpha=0.5)
plt.scatter(centroids[:, 0], centroids[:, 1], c='red', s=50)
plt.xlabel("Min Temp")
plt.ylabel("Max Temp")
plt.title("KMeans Min Temp / Max Temp")
plt.savefig(".\\plots\\kmeansMnTpMxTp.png")